...
public class CursoController {
    ...
    public Curso editCurso(@PathVariable Long id_original,
            @RequestParam(required = false, name = "id_nueva") Long id_nueva,
        ...
        cursoService.editCurso(id_original, id_nueva, nombre, modalidad, fecha_finalizacion, lista_temas);

        Curso curso = cursoService.findCurso(id_nueva);
